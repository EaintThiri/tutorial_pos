    ...
    <div class="container-fluid pb-5">
        <div class="row px-xl-5">
            <div class="col-lg-5 mb-30">
                ...
                <a href="{{ route('user#home') }}" class="text-dark "><i
                        class="fa-solid fa-arrow-left text-darkme-2"></i>Back</a>
                        ...
                        <div class="product-item bg-light">
                            <div class="product-img position-relative overflow-hidden" style="height:200px">
                                <img class="img-fluid w-100 " style="height:200px"
                                    src="{{ asset('storage/' . $pl->image) }}" alt="">
                                <div class="product-action">
                                    ...
                                    <a class="btn btn-outline-dark btn-square"
                                        href="{{ route('user#pizzaDetail', $pl->id) }}"><i class="fa-solid fa-info"></i></a>
                                </div>
                            </div>
